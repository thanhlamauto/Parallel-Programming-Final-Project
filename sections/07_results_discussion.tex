...
600 & 12 & 5x4 & 12000 & 123.667 & 114.352 & 10.31 & Selected \(N\) \\
837 & 12 & 5x4 & 16740 & 146.316 & 139.136 & 8.74 & Best ms/task, longer validation \\
1200 & 12 & 5x4 & 24000 & 178.306 & 170.255 & 7.43 & \(2N\), speedup workload \\
\bottomrule
\end{tabularx}
\end{table}

The time-per-task column shows that very small inputs have high overhead because startup, synchronization, and aggregation are amortized over too few tasks. The 1200-frame run has the best measured time per task because it amortizes overhead over 24000 tasks, but it is used as the \(2N\) speedup workload. The 600-frame run is selected as \(N\) because it is the first long-sequence case that satisfies the required 120--180 second runtime window.
