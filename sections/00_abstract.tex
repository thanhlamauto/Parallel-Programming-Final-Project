...
This report presents the final structure for the project \textit{Parallelization Methods for CNN-Based Computer Vision Inference}. The final scope focuses on one implemented method: a YOLO/OpenMPI video people-counting pipeline that parallelizes inference at task level over video frames and image tiles.
